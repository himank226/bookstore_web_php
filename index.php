                	...
                	<div id="headline_content">
                        ...
                        if(!isset($_SESSION['customer_email']))
						{
							echo "<b>Welcome Guest!</b> <b style='color:Yellow '>Shopping Cart</b>";
								...
								echo "<b>Welcome:" . "<span style='color:Yellow '>" . $_SESSION['customer_email'] . "</span>" . "</b>" . "<b style='color:yellow'>Your Shopping Cart </b>";
								}
						?> 
					   ...
					   if(!isset($_SESSION['customer_email'])){
						...
						echo "<a href='checkout.php' style='color:#FFFF00;/*#F93*/'>Login</a>";
					   }
					   else {
						   echo "<a href='logout.php' style='color:#FFFF00;/*#F93*/'>Logout</a>";
						   }
